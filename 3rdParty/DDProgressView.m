...
- (void)initSettings {
	...
	self.innerColor = [UIColor colorWithRed:20/255.0 green:35/255.0 blue:56/255.0 alpha:1.0];
	self.outerColor = [UIColor clearColor];
	self.emptyColor = [UIColor colorWithRed:74/255.0 green:182/255.0 blue:239/255.0 alpha:1.0];
}

//- (void)dealloc
//{
//    SDWISafeRelease(innerColor);
//    SDWISafeRelease(outerColor);
//    SDWISafeRelease(emptyColor);
//    SDWISuperDealoc;
//}
