...
// AFNetworking+JHMods
#define COCOAPODS_POD_AVAILABLE_AFNetworking_JHMods
#define COCOAPODS_VERSION_MAJOR_AFNetworking_JHMods 1
#define COCOAPODS_VERSION_MINOR_AFNetworking_JHMods 0
#define COCOAPODS_VERSION_PATCH_AFNetworking_JHMods 0
