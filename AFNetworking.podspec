Pod::Spec.new do |s|
  ...
  s.exclude_files = 'AFNetworking/UIKit+AFNetworking/UIImageView+AFNetworking.*'
  s.dependency 'AFNetworking+JHMods', '~> 1.0'
  ...
  s.subspec 'UIKit' do |ss|
    ...
    ss.osx.source_files = ''
    ss.exclude_files = 'UIKit+AFNetworking/UIImageView+AFNetworking.*'
  end
end
